...
Write-Host "scripts name: BackupVMserver2.ps1"
...
$VM = 'NameOfYourServer2'
$destination = 'K:\BackupVMs\'+$VM +'\' +$Bckdate

# eMail Setting
$From = 'NameOfYourServer2@domain.com'
$To = 'YourEmail@domain.com'
$Subject = 'END of Export VM ' + $VM
$smtpServer = 'YourSMTPServer'


# keep only 12 backup of this VM
forfiles -p K:\BackupVMs\$VM -d -13 -c "cmd /c rmdir /s /q @PATH" >null
